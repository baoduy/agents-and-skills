...
- `.npmignore` — excludes `.git`, `.gitnexus/`, `.claude/`, `docs/`, internal markdown (`CLAUDE.md`, `AGENTS.md`, `Karpathy-CLAUDE.md`, `CONTRIBUTING.md`). The `files` whitelist in `package.json` takes precedence.
- `Karpathy-CLAUDE.md` — behavioral baseline (think-before-code, surgical diffs, stay in scope). House style.
